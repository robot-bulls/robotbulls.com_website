...
//    document.getElementById("survey-popup").docReady.push(NioApp.Plugins.select2)
//	NioApp.components.docReady.push(NioApp.Plugins.select2);
...
$( document ).ready(function() {
    $(".apply_button").click(function() {
        $(this).find(".apply_button_loader").css("display", "block");
    });
    
//    $('.form-results').on('classChange', function() {
//        $(".apply_button_loader").css("display", "none");
//    });
    
    $('body').on('DOMSubtreeModified', '.form-results', function(){
        $(".apply_button_loader").css("display", "none");
    });
